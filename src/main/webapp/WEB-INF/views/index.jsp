		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="content-box" style="min-height: 200px">
					...
					<h3>
						<i class="icon-quote fa fa-quote-left"></i> Currency Conversion <i
							class="icon-quote fa fa-quote-right"></i>
					</h3>
					<h4>Online Currency Conversion</h4>
				</div>
			</div>
			<div class="col-md-4">
				<div class="content-box" style="min-height: 200px">
					...
					<h4>Currency Rate Converted from Authentic Sources</h4>
				</div>
			</div>
		</div>
	</div>
...
<div class="modal fade login-modal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		...
		<div class="form-container">
			<form:form method="post" action="/currencyconverter/userauth"
				modelAttribute="user">
